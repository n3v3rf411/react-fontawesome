...
exports.default = _react2.default.createClass({
  ...
  propTypes: {
    ...
    component: _react2.default.PropTypes.oneOf(['span', 'i']),
  ...
  render: function render() {
    ...
    var props = _objectWithoutProperties(_props, ['component', 'border', 'fixedWidth', 'flip', 'inverse', 'name', 'pulse', 'rotate', 'size', 'spin', 'stack']);
